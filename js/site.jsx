        ...
        <div className="highlights-copy">
          ...
          <div className="highlights-grid">
            ...
            <div className="highlight-item">
              ...
              <p>Twelve flavours at a time, never the same twelve.</p>
            </div>
            <div className="highlight-item">
      ...
      <div className="visit-find-inner">
        <div className="visit-find-left">
          ...
          <div className="addr-block">
            ...
            <div className="hours">
              <div><span>mon</span><span><em>closed</em></span></div>
              <div><span>tue — thu</span><span>1 — 10pm</span></div>
              <div><span>fri — sat</span><span>1 — 11pm</span></div>
              <div><span>sun</span><span>1 — 10pm</span></div>
            </div>
      ...
      <div className="footer-grid">
        ...
        <div className="footer-col">
          ...
          <div className="footer-hours">
            <span>Mon · <em>Closed</em></span>
            <span>Tue — Thu · 1–10 pm</span>
            <span>Fri — Sat · 1–11 pm</span>
            <span>Sun · 1–10 pm</span>
          </div>
        </div>
